...
struct Expr {
	virtual std::string emit_c() const = 0;
	virtual ~Expr() = default;
};

struct Stmt {
	virtual std::string emit_c(int indent) const = 0;
...
struct Var : Expr {
	...
	std::string emit_c() const override { return name; }
};
...
struct Assign : Stmt {
	...
	std::string emit_c(int indent) const override {
